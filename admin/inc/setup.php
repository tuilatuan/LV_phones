                        ...
                        <form action="partials/_siteManage.php" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" class="form-control" id="email" name="email"
                                    value="vanluong3011@gmail.com" required>
                            </div>
                            <div class="form-group">
                                <label for="contact" class="control-label">Liên hệ - 1</label>
                                <input type="tel" class="form-control" id="contact1" name="contact1" value="902590504"
                                    required>
                            </div>
                            <div class="form-group">
                                <label for="contact" class="control-label">Liên hệ - 2 (tùy chọn)</label>
                                <input type="tel" class="form-control" id="contact2" name="contact2" value="902590504"
                                    required>
                            </div>
                            <div class="form-group">
                                <label for="address" class="control-label">Địa chỉ</label>
                                <input type="text" class="form-control" id="address" name="address"
                                    value="273 An Dương Vương" required>
                            </div>
                            <div>
